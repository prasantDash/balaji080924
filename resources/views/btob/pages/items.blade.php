...
<div class="row">
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-sm-12 text-right">
        <br>
        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#add-new-item">Add New
            item</button>
    </div>
...
<!-- Modal -->
<div id="add-new-item" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('createItems')}}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="item">Add new item:</label>
                        <input type="text" class="form-control" name="itemname" id="item">
                    </div>
...
<script src="{{ asset('js/btob/item.js')}}"></script>
@stop